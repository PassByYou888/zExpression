...
uses SysUtils, math, Variants, CoreClasses, OpCode, UnicodeMixedLib, TextParsing;
...
type
  ...
  // 假如有pi,maxInteger这类需求时，根据DeclName判断名字，吻合时返回Value对应的3.141592654即可，浮点类型ValType根据ieee规范，追求性能单浮点精度edtSingle，精确性双浮点edtDouble
...
var
  ...
  begin
    ...
    while cPos <= umlGetLength(ParsingEng.ParsingData.Text) do
      begin
